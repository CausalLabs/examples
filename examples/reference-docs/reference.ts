...
export class ExampleFeature extends FeatureBase {
    ...
    */
     ...
     *  Control: "Example"
     */
    readonly exampleOutput: string = "Example";
    ...
    */
     ...
     * Example integer event
     */
    static signalRating( sessionKeys: SessionKeys | Session, impressionId : string,  { exampleEvent } 
        : {  exampleEvent : number  } ) : void
 {
        signalStatic("ExampleFeature", "Rating", [...arguments]);
    }
  }
...
*/
export class ExampleFeature2 extends FeatureBase {
    /** 
    * An example string argument
    */
    ...
    */
    ...
    static signalRating( sessionKeys: SessionKeys | Session, impressionId : string,  { exampleEvent } 
        : {  exampleEvent : string  } ) : void
 {
        signalStatic("ExampleFeature2", "Rating", [...arguments]);
    }
  }
